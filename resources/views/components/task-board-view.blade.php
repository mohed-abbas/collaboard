<div class="flex gap-6 min-h-[calc(100vh-12rem)] overflow-x-auto pb-4 max-w-full">
    @foreach ($categories as $category)
    @php
    $categoryTasks = $filteredTasks->where('category_id', $category->id);
    @endphp
    <div class="flex-shrink-0 w-80">
        ...
        <!-- Tasks Container - No Encapsulation -->
        <div>
