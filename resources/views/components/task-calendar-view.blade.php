    ...
    <div class="overflow-hidden">
        @foreach($calendarWeeks as $week)
            <div class="grid grid-cols-7 border-b last:border-b-0 border-slate-200 dark:border-slate-800">
                @foreach($week as $day)
                    <div class="min-h-[120px] border-r last:border-r-0 border-slate-200 dark:border-slate-800 p-1 
                        ...
                        <div class="space-y-1.5 overflow-y-auto max-h-[90px] scrollbar-hide">
                            @foreach($day['tasks'] as $task)
                                ...
                                'hover:shadow-md dark:hover:shadow-lg dark:hover:shadow-black/30 border-slate-300/50 dark:border-slate-700' }}"
                                        style="background-color: {{ $task->category->color }}20; border-color: {{ $category->color }};">
