<div>
    ...
    <h1 class="text-2xl font-bold mb-4">Paramètres du Projet</h1>
    <p class="text-gray-600 mb-6">Gérez les paramètres de votre projet ci-dessous.</p>
    <div class="bg-white shadow rounded-lg p-6">
        <form wire:submit.prevent="saveSettings">
            <div class="mb-4">
                <label for="name" class="block text-sm font-medium text-gray-700">Titre de projet</label>
            ...
            <div class="mb-4">
                ...
                <textarea id="description" wire:model="projectDescription"
                    class="mt-1 p-2 block w-full border-gray-300 rounded-md shadow-sm focus:border-blue-500 focus:ring-blue-500"
                    placeholder="Entrez la description du projet"></textarea>
        ...
        <!-- Members -->
        <div class="mt-6">
            <h2 class="text-lg font-semibold mb-4">Membres du Projet</h2>
            <div class="mt-4 relative">
                <input type="text" wire:model.live="searchMember" class="p-2 border border-gray-300 rounded-md w-full"
                    placeholder="Rechercher des utilisateurs par nom ou email pour ajouter au projet"
                    wire:focus="showSearchResults = true">
                ...
                @elseif($showSearchResults && !empty($searchMember) && count($searchResults) === 0)
                    <div class="absolute z-10 w-full mt-1 bg-white border border-gray-300 rounded-md shadow-lg p-3">
                        <div class="text-gray-500 text-sm">Aucun utilisateur trouvé correspondant à "{{ $searchMember }}"
                        </div>
                    </div>
                @endif
            </div>
            ...
            <div class="mt-6">
                <h3 class="text-md font-medium mb-3">Membres courants</h3>
