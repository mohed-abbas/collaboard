...
<div>
    ...
    />
    <select name="filter-category" id="filter-category" class="mb-4 p-2 border rounded" wire:model="selectedCategory" wire:change="filterByCategory">
    ...
    <table class="min-w-full bg-white rounded shadow w-full">
        ...
        <tbody>
            @foreach ($tasks as $task)
                <tr wire:click="$dispatch('openEditTaskModal', { taskId: {{ $task->id }} })" class="cursor-pointer hover:bg-blue-100">
